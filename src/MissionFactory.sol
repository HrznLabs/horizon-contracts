...
contract MissionFactory is Ownable, ReentrancyGuard {
    ...
    function createMission(
        ...
        // Validate duration
        // Security (MED-03): explicit expiry check before subtraction prevents
        // a silent arithmetic underflow revert if expiresAt is in the past.
     ...
     * @dev Security: zero-address guard prevents bricking dispute flow for active missions.
     */
