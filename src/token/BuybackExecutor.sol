...
contract BuybackExecutor is AccessControl {
    ...
    function executeBuyback(
        ...
        /// @dev A zero minHrznOut means no slippage protection — the swap could be
        ///      sandwiched or executed at an arbitrarily bad rate. Require a non-zero
        ///      floor to ensure every buyback has explicit slippage tolerance set.
        require(minHrznOut > 0, "BuybackExecutor: zero slippage");
