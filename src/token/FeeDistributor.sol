...
contract FeeDistributor is AccessControl {
    ...
    function distribute(uint256 amount) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        // Optimization: Merged secondary guildVolume reset loop into primary distribution loop.
        // Impact: Eliminates a redundant O(N) iteration, saving ~1110 gas on a typical distribute() call.
